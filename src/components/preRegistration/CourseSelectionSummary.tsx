...
import type { CourseTypeCounts } from '../../types/preRegistration';

interface CourseSelectionSummaryProps {
  courseTypeCounts: CourseTypeCounts;
  totalCredits: number;
  totalCourses: number;
}

const CourseSelectionSummary: React.FC<CourseSelectionSummaryProps> = ({
  courseTypeCounts,
  totalCredits,
  totalCourses
}) => (
...
export default CourseSelectionSummary;